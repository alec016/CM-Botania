...
import es.degrassi.custommachinerybotania.components.variant.item.ManaItemComponentVariant;
...
import es.degrassi.custommachinerybotania.requirements.ManaRequirementPerTick;
...
public abstract class Registration {
  public static final RegistrarManager REGISTRIES = RegistrarManager.get(CustommachineryBotania.MODID);
